...
hyper_params = {
    "aabb_fg_bg": ['[[[-4.5, -0.1, -3.5], [3.5, 4, 5]], [[-13.0, -9, -15.0], [20, 9, 15.0]]]'],
    "res_fg": [180],
    "res_bg": [250],
    ...
    "sdf_lr_bg": [0.005],
    "deform_lr_bg": [0.02],
    "final_lr_rate": [0.05, 0.03],
    "texture_lr": [0.005],
    "scale_factor_lr": [0.0005, 0.001],
...
with open(f"{config_dir}/mip_garden_template.json", "r") as f:
    template_s = f.read()
