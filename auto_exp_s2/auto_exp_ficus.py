...
hyper_params = {
    "sdf_lr": [0.005],
    "texture_lr": [0.05, 0.03],
    "scale_factor_lr": [0.002, 0.001],
    "final_lr_rate": [0.3, 0.1],
    "c2f_steps": ['[1000, 2000, 3000, 4000]'],
    "lambda_sdf": ["[0.2, 0.01]"],
    "lambda_flex": ['[0.2, 0.05]', '[0.1, 0.05]']
}
...
with open(f"{config_dir}/synthetic_ficus_template.json", "r") as f:
    template_s = f.read()
